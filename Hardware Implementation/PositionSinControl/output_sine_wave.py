...
for col in ['current_A', 'pwmCmd', 'encCount', 'rpm']:
...
fig.suptitle('Motor System Response Over Time (Sine Curve)', fontsize=16)



axs[0].plot(df['t_s'], df['current_A'], color='tab:blue', linewidth=1.5)
axs[0].plot(df['t_s'], df['filtered_A'], color='tab:red', linewidth=1.6)
...
axs[2].set_ylabel('Encoder Count', fontweight='bold')
